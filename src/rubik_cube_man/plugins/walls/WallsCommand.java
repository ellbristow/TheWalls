...
public class WallsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof Player) {
            if (args.length == 0) {
                sender.sendMessage(ChatColor.GREEN + "The Walls Minigame Plugin made by rubik_cube_man, version 1.1.0.1");
                                ...
                                if (plugin.location2.get((Player) sender) != null) {
                                    ...
                                    if (plugin.location1.get((Player) sender).getWorld() == player.getWorld()) {
                                        if (plugin.location2.get((Player) sender).getWorld() == player.getWorld()) {
                                            ...
                                            ArenaFileManager.createANewArena(arena.getName(), arena.getLoc1(), arena.getLoc2());
                                            ArenaFileManager.saveToAFile(args[1].toLowerCase());
                    ...
                    if (args.length == 3) {
                        ...
                        if (plugin.arenas.containsKey(args[2].toLowerCase())) {
                            if (args[1].equalsIgnoreCase("red")) {
                                ...
                                sender.sendMessage(ChatColor.DARK_RED + "Spawn " + plugin.arenas.get(args[2].toLowerCase()).getReds() + " spawn set in " + args[2].toLowerCase());
                                ...
                                while (itr.hasNext()) {
                                    ...
                                    plugin.arenas.get(args[2].toLowerCase()).getSignWalls().get(numi).addPlayerSign(plugin.arenas.get(args[2].toLowerCase()).getMin());
                                }
                            } else if (args[1].equalsIgnoreCase("blue")) {
                                plugin.arenas.get(args[2].toLowerCase()).setPlayerLoc(player.getLocation());
                                plugin.arenas.get(args[2].toLowerCase()).addBlueSpawn();
                                sender.sendMessage(ChatColor.DARK_BLUE + "Spawn " + plugin.arenas.get(args[2].toLowerCase()).getBlues() + " spawn set in " + args[2].toLowerCase());
                                plugin.arenas.get(args[2].toLowerCase()).min();
                                Iterator<Integer> itr = plugin.arenas.get(args[2].toLowerCase()).getSignWalls().keySet().iterator();
                                while (itr.hasNext()) {
                                    Integer numi = itr.next();
                                ...
                                sender.sendMessage(ChatColor.DARK_GREEN + "Spawn " + plugin.arenas.get(args[2].toLowerCase()).getGreens() + " spawn set in " + args[2].toLowerCase());
                                plugin.arenas.get(args[2].toLowerCase()).min();
                                Iterator<Integer> itr = plugin.arenas.get(args[2].toLowerCase()).getSignWalls().keySet().iterator();
                                while (itr.hasNext()) {
                                    Integer numi = itr.next();
                                ...
                                sender.sendMessage(ChatColor.YELLOW + "Spawn " + plugin.arenas.get(args[2].toLowerCase()).getYellows() + " spawn set in " + args[2].toLowerCase());
                                plugin.arenas.get(args[2].toLowerCase()).min();
                                Iterator<Integer> itr = plugin.arenas.get(args[2].toLowerCase()).getSignWalls().keySet().iterator();
                                while (itr.hasNext()) {
                                    Integer numi = itr.next();
                                    ...
                                    if (plugin.arenas.get(arena).getLose() != null && plugin.arenas.get(args[1].toLowerCase()).getWin() != null && plugin.arenas.get(args[1].toLowerCase()).getLobby() != null) {
                                        if (plugin.arenas.get(arena).getMin() > 0) {
                                            if (plugin.arenas.get(arena).getDropTime() != null) {
                                                Player player = (Player) sender;
                                                Integer numi = plugin.arenas.get(arena).getMin() + plugin.arenas.get(args[1].toLowerCase()).getMin() + plugin.arenas.get(args[1].toLowerCase()).getMin() + plugin.arenas.get(args[1].toLowerCase()).getMin();
                                                if (plugin.arenas.get(arena).getTotal() < numi) {
                                ...
                                if (plugin.location2.get((Player) sender) != null) {
                                    ...
                                    if (plugin.location1.get((Player) sender).getWorld() == player.getWorld()) {
                                        if (plugin.location2.get((Player) sender).getWorld() == player.getWorld()) {
                                            ...
                                            Integer numi = plugin.arenas.get(args[1].toLowerCase()).getTotalDrops() + 1;
                                            sender.sendMessage(ChatColor.GOLD + "Drop Location number " + numi + " set for arena " + args[1].toLowerCase());
                ...
                if (sender.hasPermission("walls.info")) {
                    if (args.length >= 2) {
                        if (plugin.arenas.containsKey(args[1].toLowerCase())) {
                            ...
                            sender.sendMessage(ChatColor.GRAY + "Drop Locations: " + numi);
                        ...
                        if (plugin.playerarena.get((Player) sender) != null) {
                            if (arena.getStarted()) {
                                ...
                                while (itr.hasNext()) {
                                    ...
                                    if ("red".equals(arena.getPlayerList().get(play))) {
                                        reds = reds + play.getName() + ", ";
                                    }
                                    if ("blue".equals(arena.getPlayerList().get(play))) {
                                        blues = blues + play.getName() + ", ";
                                    }
                                    if ("green".equals(arena.getPlayerList().get(play))) {
                                        greens = greens + play.getName() + ", ";
                                    }
                                    if ("yellow".equals(arena.getPlayerList().get(play))) {
                        ...
                        if (args[1].equalsIgnoreCase("config")) {
                            ...
                            if (args.length >= 3) {
                                if (plugin.arenas.containsKey(args[2].toLowerCase())) {
                                    ...
                                    ArenaFileManager.arenas.get(args[2].toLowerCase()).updateInfo(arena.getLoc1(), arena.getLoc2());
                                    ArenaFileManager.saveToAFile(args[2].toLowerCase());
                                    sender.sendMessage(ChatColor.GOLD + "Saved the arena!");
                                } else {
                                    sender.sendMessage(ChatColor.RED + "That arena does not exist");
                                }
